            ...
            {!loading &&
              (user ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={logout}
                    className="px-3 py-1.5 rounded-lg text-xs font-semibold text-muted hover:text-label hover:bg-surface-hi transition-all"
                  >
                    Sign out
                  </button>
                </div>
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg text-sm font-semibold bg-accent text-white hover:opacity-90 transition-opacity"
                >
                  Sign in
                </button>
              ))}
