...
export default function PositionBanner({ label, event, moveNumber, orientation, pgn }: PositionBannerProps) {
  return (
    <div className="rounded-xl border border-edge-hi bg-surface px-6 py-5 flex items-center justify-between gap-8 shadow-lg shadow-black/30">
      <div className="min-w-0">
        <h2 className="font-black text-2xl text-text leading-tight">
          {pgn ? (
            <a
