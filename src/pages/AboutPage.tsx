  ...
  return (
    <main className="max-w-2xl mx-auto px-8 py-16 flex flex-col gap-10">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-label leading-relaxed">
          You're shown a position and asked to find the engine's top 5 moves. No
          eval bar, no hints. The goal is to force deliberate candidate move
          thinking before reaching for the engine.
        </p>
